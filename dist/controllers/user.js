...
exports.uploadProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.listProduct = (req, res, next) => {
    ...
    Product_1.Product.find((err, value) => {
        for (const t in value) {
            fs_1.default.readdirSync(UPLOAD_PATH + value[t].imagePath).forEach(file => {
...
exports.deleteProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedRecord = yield Product_1.Product.deleteOne({ id: req.query.id });
    if (deletedRecord)
        return res.status(200).jsonp({ item: deletedRecord });
    else {
...
exports.updateProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const doc = yield Product_1.Product.findOneAndUpdate(filter, updateValue, { useFindAndModify: false });
    res.jsonp(doc);
});
exports.otpCheck = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    yield express_validator_1.check("phoneNumber", "PhoneLenght is 10").isLength({ min: 10, max: 10 }).run(req);
    // await check("phoneNumber", "PhoneLenght is 10").isNumeric().run(req);
    yield express_validator_1.check("code", "Password cannot be blank").isLength({ min: 4, max: 4 }).run(req);
...
exports.sendMessageApi = (req, res, next) => {
    ...
    Message_1.Message.findOne({ phoneNumber: req.body.phoneNumber }, (err, existingUser) => {
        if (err) {
            return next(err);
        }
        if (existingUser) {
...
exports.postLogin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    yield express_validator_1.check("phoneNumber", "phoneNumber is not valid").isString().run(req);
    yield express_validator_1.check("password", "Password cannot be blank").isString().run(req);
...
exports.postSignup = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    yield express_validator_1.check("phoneNumber", "phoneNumber is not valid").isMobilePhone("any").run(req);
    yield express_validator_1.check("password", "Password must be at least 4 characters long").isLength({ min: 4, max: 4 }).run(req);
    ...
    User_1.User.findOne({ phoneNumber: req.body.phoneNumber }, (err, existingUser) => {
        if (err) {
            return next(err);
        }
        if (existingUser) {
...
exports.postUpdateProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    yield express_validator_1.check("phoneNumber", "Please enter a valid phoneNumber address.").isMobilePhone("en-IN").run(req);
    // eslint-disable-next-line @typescript-eslint/camelcase
...
exports.postForgot = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    yield express_validator_1.check("phoneNumber", "Please enter a valid email address.").isEmail().run(req);
    // eslint-disable-next-line @typescript-eslint/camelcase
    // await sanitize("email").normalizeEmail({ gmail_remove_dots: false }).run(req);
    const errors = express_validator_1.validationResult(req);
    if (!errors.isEmpty()) {
    ...
    async_1.default.waterfall([
        ...
        function setRandomToken(token, done) {
            User_1.User.findOne({ phoneNumber: req.body.phoneNumber }, (err, user) => {
                if (err) {
                    return done(err);
                }
                if (!user) {
